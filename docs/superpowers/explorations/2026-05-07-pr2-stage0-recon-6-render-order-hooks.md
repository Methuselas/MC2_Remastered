...
| 10 | M2d overlay emit calls `gos_PushTerrainOverlay` | [`mclib/quad.cpp:2056`](../../../mclib/quad.cpp), `:2063`, `:2072`, `:2079` | M |
...
| 14 | `drawMine()` emit sites | [`mclib/quad.cpp:4379`](../../../mclib/quad.cpp), `:4380`, `:4384`, `:4385` (cited per brainstorm; lines may have drifted — re-verify at spec time) | NF (deferred — file too large to confirm here, brainstorm cite stands as-of 2026-05-01) |
