...
Stronger sibling: the exe-embedded deploy fingerprint ("[BUILD_FINGERPRINT v1]"
startup banner, generated by cmake/GenerateBuildFingerprint.cmake, asserted by
scripts/run_smoke.py via scripts/smoke_lib/fingerprint.py). The fingerprint
travels WITH the exe across copies; this filesystem manifest does not.
