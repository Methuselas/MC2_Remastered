...
2. **Deploy exe**:
```bash
cp -f "<worktree>/build64/RelWithDebInfo/mc2.exe" "A:/Games/mc2-opengl/mc2-win64-v0.3/mc2.exe"
```
...
for dll in avcodec-61.dll avformat-61.dll avutil-59.dll swscale-8.dll swresample-5.dll; do
    cp -f "<worktree>/build64/RelWithDebInfo/$dll" "A:/Games/mc2-opengl/mc2-win64-v0.3/$dll"
    diff -q "<worktree>/build64/RelWithDebInfo/$dll" "A:/Games/mc2-opengl/mc2-win64-v0.3/$dll"
done
```
