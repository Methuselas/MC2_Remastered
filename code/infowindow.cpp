...
void InfoWindow::drawScrollingStuff()
{
	...
	long ammo[60];
	char ranges[60];
	unsigned char names[60];// sebi: changed long to char; MUST be unsigned — masterID (CompBas#) can be >=128 for Clan components, signed char would underflow IDS_COMP_ABBR0+names[i]
